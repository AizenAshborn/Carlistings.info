        ...
        <div>
          ...
          <div className="flex gap-8 mt-4">
            <div>
              ...
              <p className="font-mono text-lg font-bold text-foreground">${result.asking_price.toLocaleString()}</p>
            </div>
            <div>
              <p className="font-mono text-[10px] text-muted-foreground tracking-widest">ODOMETER</p>
              <p className="font-mono text-lg font-bold text-foreground">{result.mileage_metric.toLocaleString()} km</p>
            </div>
          </div>
        </div>
